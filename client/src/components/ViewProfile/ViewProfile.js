      ...
      return (
        <div id="eventsContainer">
          <div class="row" id="rightCol">
            ...
            <span class="col s6 m6 l6" id="address">
              <Icon>add_location</Icon>
              {event.address}
            </span>
            <span class="col s6 m6 l6">
              Created: {event.createdAt.split("T")[0]}
            </span>
            <span class="col s6 m6 l6" id="dateRange">
              <Icon>date_range</Icon>
              {event.date.split("T")[0]}
            </span>
            <span class="col s6 m6 l6" id="sportType">
              Sport:
              {event.sportType}
            </span>
          </div>
              ...
              <img
                ...
                src={
                  this.state.image === null
                    ...
                    : `data:image/${this.state.ext};base64,${this.state.image}`
                }
              />
              <div>
                <p>{this.state.name}</p>
